...
<nav class="border-gray-200 px-2 mb-10">
  ...
  <a href="../Layout/addChartCard" class="inline-block bg-blue-500 p-1 rounded">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="file mt-1 h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 lg:h-6 lg:w-6 xl:h-8 xl:w-8">
